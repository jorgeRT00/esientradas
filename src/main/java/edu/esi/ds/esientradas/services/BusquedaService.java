...
public class BusquedaService {
     ...
     * Usado para que el frontend sepa si mostrar interfaz de ZONAS (CONCIERTO/ESTADIO)
     * o interfaz de BUTACAS (TEATRO).
     * 
     * @param espectaculoId ID del espectáculo
     * @return DTO con tipo de escenario y lista de entradas disponibles
     */
    public EntradasYEscenarioDTO getEntradasDisponiblesConEscenario(Long espectaculoId) {
        // Obtener el espectáculo para acceder al escenario
        ...
        // Obtener las entradas disponibles formateadas
